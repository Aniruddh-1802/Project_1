"""
DE3 - Spark processing job.

Reads the validated CSVs that DE2 moved into data/raw, cleans and
aggregates them, enriches them with the static Milan grid reference,
and publishes the processed and analytics layers as Parquet.

Run on Windows (this machine has Java 17 + pyspark; WSL does not):

    python "C:\\Users\\aniruddh.singh\\Documents\\Project_1\\Data Engineering\\de3_spark.py"
"""
...
# ============================================================
# SPARK-ON-WINDOWS ENVIRONMENT
#
# Must be set before the SparkSession is created. HADOOP_HOME
# must point at the Hadoop build that actually contains
# winutils.exe, otherwise the Parquet writes fail.
# ============================================================
...
# ABSOLUTE PATHS
#
# INPUT_PATH      raw zone, populated by DE2
# OUTPUT_PATH     processed zone (cleaned rows, partitioned by date)
# ANALYTICS_PATH  analytics zone (aggregated + geo-enriched), read by DE6
# REFERENCE_PATH  static Milan grid reference, never re-ingested
#
# The processed/analytics folders are DE3-specific on purpose so that
# this job does not overwrite the SP-lab outputs already sitting in
# data\processed\activity and data\analytics\hourly_grid_summary.
# ============================================================

INPUT_PATH = r"C:\Users\aniruddh.singh\Documents\Project_1\data\raw"

OUTPUT_PATH = r"C:\Users\aniruddh.singh\Documents\Project_1\data\processed\de3_clean_activity"

ANALYTICS_PATH = r"C:\Users\aniruddh.singh\Documents\Project_1\data\analytics\de3_grid_activity_enriched"
